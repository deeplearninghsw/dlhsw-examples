...
x_train, x_test, y_train, y_test = train_test_split(x_cords, y_cords, test_size=0.20, random_state=np.random.seed(65)) #6
...
if Gaussian_Mixture : 
    ...
    gmm = GaussianMixture(n_components=3, covariance_type='diag').fit(X) #full
    ...
    fig, ax = plt.subplots()
    ax.scatter(x_cords[y_cord_1],y_cords[y_cord_1], label='cluster 1', c='blue')
    ax.scatter(x_cords[y_cord_2],y_cords[y_cord_2], label='cluster 2', c='orange')
    ax.scatter(x_cords[y_cord_3],y_cords[y_cord_3], label='cluster 3', c='green')
    ax.legend()
    plt.show()
    ...
    ax1.scatter(x_cords[y_cord_1],y_cords[y_cord_1], c='blue', label='cluster 1', linewidth=0.5)
    ax1.scatter(x_cords[y_cord_1],predData1, c='black', label='Fit 1', linewidth=0.5, marker = '.')
    ax1.scatter(x_cords[y_cord_2],y_cords[y_cord_2], c='orange', label='cluster 2', linewidth=0.5)
    ax1.scatter(x_cords[y_cord_2],predData2, c='black', label='Fit 2', linewidth=0.5, marker = '.')
    ax1.scatter(x_cords[y_cord_3],y_cords[y_cord_3], c='green', label='cluster 3', linewidth=0.5)
    ax1.scatter(x_cords[y_cord_3],predData3, c='black', label='Fit 3', linewidth=0.5, marker = '.')
    ax1.legend()
    plt.show()
